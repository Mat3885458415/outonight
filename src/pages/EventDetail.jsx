...
const MOCK_EVENTS = {
  1: { name: 'Techno Night #12', venue: 'Club Rubín', date: 'Fri 18 Apr', time: '10:00pm', price: '150 CZK', emoji: '🎵', color: '#e8eaf6', desc: "The best techno night of the month. 4h DJ set, bar open until 4am. Don't miss it.", attendees: [{n:'Mat',c:'#c5cae9',u:'UTB · France',f:'🇫🇷'},{n:'Jana K.',c:'#b2dfdb',u:'UTB · Czech',f:'🇨🇿'},{n:'Andrea L.',c:'#ffccbc',u:'UTB · Spain',f:'🇪🇸'},{n:'Karim B.',c:'#fff9c4',u:'UTB · Morocco',f:'🇲🇦'},{n:'Sofia R.',c:'#fce4ec',u:'UTB · Italy',f:'🇮🇹'},{n:'Lena W.',c:'#dcedc8',u:'UTB · Germany',f:'🇩🇪'}] },
  2: { name: 'Thursday Happy Hour', venue: 'Bar Panorama', date: 'Thu 17 Apr', time: '8:00pm', price: '80 CZK', emoji: '🍺', color: '#e3f2fd', desc: '2-for-1 beers until 10pm. Popular with UTB students. Good music and chill atmosphere.', attendees: [{n:'Lena W.',c:'#dcedc8',u:'UTB · Germany',f:'🇩🇪'},{n:'Pedro M.',c:'#bbdefb',u:'UTB · Portugal',f:'🇵🇹'}] },
  3: { name: 'Erasmus Night', venue: 'Erasmus Zlín', date: 'Sat 19 Apr', time: '9:00pm', price: 'Free', emoji: '🎤', color: '#ede7f6', desc: 'Monthly Erasmus party. Meet students from all over the world. Free entry with UTB student card.', attendees: [{n:'Karim B.',c:'#fff9c4',u:'UTB · Morocco',f:'🇲🇦'},{n:'Sofia R.',c:'#fce4ec',u:'UTB · Italy',f:'🇮🇹'},{n:'Andrea L.',c:'#ffccbc',u:'UTB · Spain',f:'🇪🇸'},{n:'Jana K.',c:'#b2dfdb',u:'UTB · Czech',f:'🇨🇿'}] },
  4: { name: 'UTB Football Match', venue: 'UTB Sports Ground', date: 'Wed 16 Apr', time: '6:00pm', price: 'Free', emoji: '⚽', color: '#e8f5e9', desc: 'Weekly open football game. All levels welcome. Bring water and energy.', attendees: [{n:'Adam P.',c:'#dcedc8',u:'UTB · Czech',f:'🇨🇿'},{n:'Radek M.',c:'#b2dfdb',u:'UTB · Czech',f:'🇨🇿'}] },
  5: { name: 'Open Basketball 3v3', venue: 'UTB Gym', date: 'Sat 19 Apr', time: '2:00pm', price: 'Free', emoji: '🏀', color: '#e3f2fd', desc: 'First 3v3 tournament. Sign up solo or with a team. Prizes for the top 3.', attendees: [{n:'Nikola H.',c:'#bbdefb',u:'UTB · Czech',f:'🇨🇿'}] },
}
