  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        <button className={styles.btnApple} onClick={handleApple}>
        ...
        <input className={styles.input} placeholder="Email address" type="email" value={email} onChange={e => setEmail(e.target.value)} />
        ...
        <button className={styles.btnSubmit} onClick={handleEmail} disabled={loading}>
