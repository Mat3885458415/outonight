    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <div className={styles.form}>
          {mode === 'signup' && <input className={styles.input} placeholder="Your name" autoComplete="off" />}
          <input className={styles.input} placeholder="Email address" type="email" autoComplete="off" />
          <input className={styles.input} placeholder="Password" type="password" />
          <button className={styles.btnSubmit} onClick={onLogin}>
